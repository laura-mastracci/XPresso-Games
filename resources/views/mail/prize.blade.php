...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Jersey+10&family=Pixelify+Sans:wght@400..700&display=swap"
        rel="stylesheet">
    <title>{{ __('ui.titoloMailPremio') }}</title>
...
<div class="full-page-bg">
    <div class="container email-wrapper">
        ...
        <!-- Contenuto Email -->
        <h2 class="mt-3 text-white title-font">{{ __('ui.bodyMailPremio') }}</h2>
        <p class="fs-4 text-white title-font"> <strong>{{ __('ui.discountCode') }}: {{ $discountPercentage }}% {{ __('ui.onYourOrder') }}</strong></p>
        <p class="fs-4 text-white title-font"> <strong>{{ __('ui.withCode') }}: {{ $discountCode }}</strong></p>
    </div>
</div>
